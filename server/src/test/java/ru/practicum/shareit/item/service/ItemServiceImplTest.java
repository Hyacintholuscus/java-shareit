...
class ItemServiceImplTest {
    ...
    public void shouldSearchItem() {
        ...
        final List<ItemDto> searchItEmDto = itemService.search(1L, "ItEm", pageable);
        ...
        final List<ItemDto> searchWithoutDto = itemService.search(1L, "without", pageable);
    ...
    public void shouldReturnCorrectPagination() {
        ...
        // Проверка с search
        final List<ItemDto> searchTwoDto = itemService.search(1L, "item", pageableAt0);
        ...
        final List<ItemDto> searchOneDto = itemService.search(1L, "item", pageableAt3);
